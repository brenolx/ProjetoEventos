...
public class TelaGerenciamentoEventos extends JFrame {
	...
	public TelaGerenciamentoEventos(TelaPrincipalAdmin telaAdmin, Administrador adm) throws IOException {
	...
	private void verEventoDetalhado() {
	    ...
	    if (selectedRow != -1) {
	        int eventoId = (int) model.getValueAt(selectedRow, 0); // Obtém o ID do evento da linha selecionada
	        TelaEventoDetalhado telaEventoDetalhado = new TelaEventoDetalhado(TelaGerenciamentoEventos.this, eventoId); // Passa o ID do evento para a tela de detalhes
	...
	public static void main(String[] args) throws IOException {
		TelaGerenciamentoEventos tela = new TelaGerenciamentoEventos(null, null);
