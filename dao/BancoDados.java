...
public class BancoDados {
	...
	public static synchronized Connection conectar() throws SQLException, IOException {
		try {
			if (conn == null) {
			...
			if (e instanceof com.mysql.cj.jdbc.exceptions.CommunicationsException) {
				JOptionPane.showMessageDialog(null,
						"Erro de comunicação com o servidor MySQL. Verifique se o servidor está em execução e a configuração da conexão.");
			} else {
	...
	public static synchronized Connection desconectar() throws SQLException {
	...
	private static synchronized Properties carregarPropriedades() throws IOException {
	...
	public static synchronized void finalizarStatement(Statement st) throws SQLException {
	...
	public static synchronized void finalizarResultSet(ResultSet rs) throws SQLException {
